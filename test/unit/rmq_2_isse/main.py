...
"""Program:  main.py
    ...
    Description:  Unit testing of main in rmq_2_isse.py.
...
class UnitTest(unittest.TestCase):
    ...
    @mock.patch("rmq_2_isse.gen_libs.help_func")
    @mock.patch("rmq_2_isse.arg_parser.arg_parse2")
    ...
    @mock.patch("rmq_2_isse.gen_libs.help_func")
    @mock.patch("rmq_2_isse.arg_parser")
    ...
    @mock.patch("rmq_2_isse.run_program")
    @mock.patch("rmq_2_isse.gen_libs.help_func")
    @mock.patch("rmq_2_isse.arg_parser")
